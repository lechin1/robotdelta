 ...
 namespace RobotDelta
{
    public class DeltaKinematics
 {
        ...
        public static class DeltaRobot
  {
    ...
    static double e = 45.1;    // e=E/2√3 Với E cạnh bên tam giác đế di động 


    // f: bán kính đế cố định
    static double f = 200; // f=F/2√3 Với E cạnh bên tam giác đế cố định 
    ...
    // ================================
    // cấu trúc hàm:
    // static int tên_hàm(tham_số, out biến...)
    ...
    // ================================
    public static int delta_calcAngleYZ(
        double x0,
        double y0,
        double z0,
        out double theta)
